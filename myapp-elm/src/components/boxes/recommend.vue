    ...
    <div class="recommend">
      <header class="ttx_head_top">
        ...
        <section class="ttx_title_head_ellipsis">
          <span class="ttx_title_text">推荐有奖</span>
        </section>
      </header>
      <!---->
      ...
      <section class="invite_num">
        <div class="invite_num_style">
          <p class="p21">累积收益</p>
          <p class="p21"><span class="span22">0</span>元</p>
        </div>
        <div class="invite_people">
          <p class="p31">成功邀请</p>
          <p class="p32"><span class="span30">0</span>人</p>
        </div>
      </section>
      ...
      <!--弹框-->
      <section v-if="show"  class="tip_text_container">
        <div class="tip_icon">
          <span class="span1"></span>
          <span class="span2"></span>
        </div>
        <p class="tip_text">请在饿了么App中打开</p>
        <div class="confrim" @click="tan">确认</div>
      </section>
    </div>
