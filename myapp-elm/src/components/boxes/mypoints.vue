  ...
  <div class="ttx_balance">
    <header class="ttx_head_top">
      ...
      <section class="ttx_title_head_ellipsis">
        <span class="ttx_title_text">我的积分</span>
      </section>
    </header>
    <div class="ttx_content_container">
      <div class="content_header">
        <div class="content_header-overflow">
          <span class="ttx_content_title_style">当前积分</span>
          <section class="ttx_contetn_description">
            <img id="ttx_imgs"
                 ...
                 alt="">
            <router-link to="/explain">积分说明</router-link>
          </section>
        </div>
        <div class="ttx_content_num">
          <p>
            <span style="font-size: 2rem">0</span>
            <span>分</span>
          </p>
        </div>
        <div class="ttx_promit_button" @click="tan_123">积分兑换商品</div>
      </div>
    </div>
    <div class="ttx_xb">
      <p>最近30天积分记录</p>
