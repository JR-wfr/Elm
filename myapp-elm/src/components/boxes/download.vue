  ...
  <div>
    <header class="ttx_head_top">
      ...
      <section class="ttx_title_head_ellipsis">
        <span  class="ttx_title_text">下载</span>
      </section>
    </header>
    <section class="dowload_container">
      <img class="logo_img"
           ...
           alt="">
      <p>下载饿了么APP</p>
      <div @click="show5" class="determine">下载</div>
    </section>
    <!--弹框-->
    <div v-if="show1" class="alet_container">
      <div class="tip_text_container">
        <div class="tip_icon">
          <span id="ttx_sp1"></span>
          <span id="ttx_sp2"></span>
        </div>
        <p class="tip_text">IOS用户请前往AppStore下载</p>
        <div @click="show2" class="confrim">确认</div>
      </div>
    </div>
  </div>
</template>
