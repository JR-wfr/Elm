<template>
  ...
  <header class="ttx_head_top">
    ...
    <section class="ttx_title_head_ellipsis">
      <span class="ttx_title_text">红包问题</span>
    </section>
  </header>
    <h3>Q1: 特权介绍 * 免配送费：饿了么会员卡绑定账户，每日前3单在「蜂鸟专送」标识商家免配送费。 * 更多特权，敬请期待！ ### Q2: 温馨提示 * 用户在当前会员服务失效前，无法购买新卡。 * 请认准饿了么官方渠道，任何从其他第三方途径获得的会员卡，饿了么不保证其可用性。</h3>
  </div>
</template>
