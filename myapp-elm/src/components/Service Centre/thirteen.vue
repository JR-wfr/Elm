<template>
  ...
  <header class="ttx_head_top">
    ...
    <section class="ttx_title_head_ellipsis">
      <span class="ttx_title_text">补签规则</span>
    </section>
  </header>
  <!--<p>payment,balance,hongbao,pointtext,member,activity,other</p>-->
    <h4>payment,balance,hongbao,pointtext,member,activity,other</h4>
  </div>
</template>
